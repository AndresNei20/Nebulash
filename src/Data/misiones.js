export const misionesEstelares = [
  {
    id: 1,
    type: 'competitivo',
    line1: 'Desafío',
    line2: 'estelar',
    description: 'Vas a tener que enfrentarte a un jugador en un juego de piedra, papel o tijera. El primero que gane 3 veces va a conquistar el planeta.'
  },
  {
    id: 2,
    type: 'competitivo',
  ...
  },
  {
    ...
    line1: 'Reacción',
    line2: 'lumínica',
    description: 'Compite contra otro jugador en una carrera de reacciones. Ambos deben presionar un botón digital (puede ser en una aplicación) tan pronto como una señal (luz o sonido) se active. El que tenga la reacción más rápida 3 veces conquista el planeta.'
  },
  {
    id: 8,
    type: 'individual',
    line1: 'Trivia',
    line2: 'universal',
    description: 'Presiona el botón de letras aleatorias. Tú y otro jugador deben formar la palabra más larga posible relacionada con el espacio usando esas letras. El que forme la palabra más larga y válida conquista el planeta.'
  }
];


export const misionesEspeciales = [
  {
    id: 1,
    type: 'competitivo',
    line1: 'Desafío',
